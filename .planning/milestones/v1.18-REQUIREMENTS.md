# Requirements Archive: v1.18 Per-Visualization Filter Selection
...
- [x] **COMM-V118-02**: Each WMS map **layer** surfaces a per-layer **"X of Y filters"** indicator in the **LayersLegendPanel** — shown ONLY when that layer ignores ≥1 active filter, reusing the widget-badge scope-summary semantics (layer.filter_scope vs the layer's active filters + spatial; dv-bound layers use dvFilters, no spatial; respects DISABLE_DV_FILTER_SCOPE). Promoted from deferred COMM-V2-02 into v1.18 during Phase-96 UAT (2026-06-29); delivered by the 96-03 gap plan.
...
| COMM-V118-02 | Phase 96 (UAT gap, 96-03) | Complete |
| VERIFY-V118-01 | Phase 96 | Complete |
