...
- [x] 108-02-PLAN.md — Panel wiring: applies-to line/expander + hover→ring / click→scroll+flash in FilterChip panel variant + DashboardsPage group builders [wave 2, depends 108-01] (completed 2026-07-10, see 108-02-SUMMARY.md)
